...
| ---- | -------------------- | -------------------- | ---------------------------------------------------------------- |
| 1    | Tokenization         | `src/tokenizer.py`   | [Tokenization.md](Tutorial/01%20-%20Tokenization.md)             |
| 2    | Embeddings           | `src/layers.py`      | [Embeddings.md](Tutorial/02%20-%20Embeddings.md)                 |
| 3    | Positional Encoding  | `src/layers.py`      | [PositionalEncoding.md](Tutorial/03%20-%20PositionalEncoding.md) |
| 4    | Attention            | `src/attention.py`   | [Attention.md](Tutorial/04%20-%20Attention.md)                   |
| 5    | Feed-Forward Network | `src/transformer.py` | [FeedForwardNetwork.md](Tutorial/05%20-%20FeedForwardNetwork.md) |
| 6    | Transformer Block    | `src/transformer.py` | [TransformerBlock.md](Tutorial/06%20-%20TransformerBlock.md)     |
| 7    | Full GPT Model       | `src/model.py`       | [GPTModel.md](Tutorial/07%20-%20GPTModel.md)                     |
| 8    | Training             | `src/optimizer.py`   | [Training.md](Tutorial/08%20-%20Training.md)                     |
| 9    | Text Generation      | `src/model.py`       | [TextGeneration.md](Tutorial/09%20-%20TextGeneration.md)         |
| 10   | Fine-Tuning          | `src/lora.py`        | [FineTuning.md](Tutorial/10%20-%20FineTuning.md)                 |
